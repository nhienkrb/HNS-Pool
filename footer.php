  ...
  <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-10">
    ...
    <div>
      ...
      <div class="register-email space-y-3 mt-2 w-full max-w-md">
        ...
        <div class="relative">
          ...
          <button
            class="absolute right-1 top-1/2 -translate-y-1/2 bg-[#0D4A9A] text-white py-2 px-3 cursor-pointer rounded transition text-sm"
          >
            <img 
              src="<?php echo get_template_directory_uri(); ?>/assets/images/Vector-right.svg"
              class="h-[17px]" 
              alt="Vector-right"
            >
          </button>
    ...
    <div class="mx-auto">
      ...
      <ul class="space-y-2 text-base">
        ...
        <li><a href="#" class="hover:underline">Hồ bơi</a></li>
        <li><a href="#" class="hover:underline">Composite</a></li>
        <li><a href="#" class="hover:underline">Tin tức</a></li>
        <li><a href="#" class="hover:underline">Dự án tiêu biểu</a></li>
    ...
    <div class="h-[149px]">
      ...
      <img 
        src="<?php echo get_template_directory_uri(); ?>/assets/images/page-web.png"
        class="rounded-md h-[149px] w-full object-cover"
        alt="Fanpage"
      >
    </div>
  </div>
