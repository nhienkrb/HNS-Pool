{{--
  Template Name: Trang Tin tức Chi tiết
--}}
    ...
    <div class="container mx-auto px-4">
        <section>
            <div class="header-gt my-10">
                <h3 class="text-4xl font-medium leading-14">Top 17 hồ bơi TPHCM đẹp và sang chảnh nhất | Vườn An Nam
                </h3>
            </div>
        ...
        <section>
            <div class="flex justify-start items-center mt-5 gap-2.5">
                <button class="text-white font-semibold text-sm px-8 py-1.5 bg-[#0D4A9A] rounded-md">New</button>
                <div class="w-1 h-1 bg-black rounded-full"></div>
                <p class="font-semibold text-base leading-4 text-black">15.10.2025</p>
                <div class="w-1 h-1 bg-black rounded-full"></div>
                <p class="font-semibold text-base leading-4 text-black">Join Smith</p>
            </div>
        </section>

        <section>
            <div class="mt-10 space-y-3">
                <img class="w-full h-[777px]" src="@asset('images/tu-van-detail-1.png')" alt="tu-van-detail-1">
        ...
        <section>
            <div class="mt-10 space-y-3">
                ...
                <img class="w-full h-[777px]" src="/src/img/tu-van-detail-1.png" alt="tu-van-detail-1">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide h-[480px] ">
                            <div
                                ...
                                <img src="/src/img/tin-tuc-4.png" class="w-full h-[305px] object-cover p-3 rounded-3xl" />
